    ...
    <header class="header-bar">
      <div class="header-inner">
        ...
        <div class="header-left">
          ...
          <el-dropdown v-if="!isMobile" trigger="click" popper-class="city-dropdown">
        ...
        <div class="header-right">
          <div v-if="!isMobile" class="global-search">
          ...
          <el-badge :value="unreadCount" :hidden="!unreadCount" class="header-icon-btn" @click="router.push('/student/messages')">
...
import {
  ...
  Document, ChatDotRound, TrendCharts, Service
